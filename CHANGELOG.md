...
- Stabilizers do not restore terrain, destroy nests, load chunks, suppress moving contraptions, or add containment UI. Further recipe and operating balance is reserved for R9.
